...
var asuraMardan, levelNo, instruction;
...
function preload(){
  ...
  levelNoImg = loadImage("assets/l1.png");
...
function setup() {
  ...
  levelNo = createSprite(850,45);
  levelNo.addImage(levelNoImg);
  levelNo.scale=0.15;

  instruction= createSprite(1160,55);
  instruction.addImage(instructionImg);
  instruction.scale=0.15;
  
  trex = createSprite(222,410);
